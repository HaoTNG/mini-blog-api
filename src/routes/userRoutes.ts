...
router.route("/mod/user").get(protect, restrictTo('moderator'), userController.getAllUsers);
router.route("/mod/user/:id").delete(protect, restrictTo('moderator'), userController.deleteUser);
